...
public class VentanaTablaASP extends JInternalFrame implements ActionListener {

	private Gestion gd;
	private JTable tblAspirantes;
	
	public VentanaTablaASP(Gestion gd){
		this.gd=gd;
        ...
        JLabel lblTitulo = new JLabel(lang.getString("listasAspirante"));
	...
	public void cargarDatos(){
		tblAspirantes.setModel(new TablaAspirante(gd.getAspirantes()));
